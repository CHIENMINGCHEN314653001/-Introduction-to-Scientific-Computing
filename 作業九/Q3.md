...
to remove the arbitrary constant $$C_2$$.
...
The calculated convergence order is approximately 2.00. This confirms that the numerical scheme is indeed second-order accurate.
